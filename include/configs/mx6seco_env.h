...
#define MACRO_ENV_KERNEL_SRC_USDHCI     \
	fatload mmc ${kernel_device_id}:${kernel_partition}  ${kernel_loadaddr} ${kernel_file}

#define MACRO_ENV_KERNEL_SRC_USB     \
	usb start; fatload usb ${kernel_device_id}:${kernel_partition} ${kernel_loadaddr} ${kernel_file}
...
#define MACRO_ENV_FDT_SRC_USDHCI     \
	fatload mmc ${fdt_device_id}:${fdt_partition}  ${fdt_loadaddr} ${fdt_file}

#define MACRO_ENV_FDT_SRC_USB     \
	usb start; fatload usb ${fdt_device_id}:${fdt_partition} ${fdt_loadaddr} ${fdt_file}
...
#define MACRO_ENV_FDT_OVERLAY_SRC_USDHCI     \
	fatload mmc ${fdt_device_id}:${fdt_partition}

#define MACRO_ENV_FDT_OVERLAY_SRC_USB     \
	usb start; fatload usb ${fdt_device_id}:${fdt_partition}

#define MACRO_ENV_FDT_OVERLAY_SRC_SATA    \
	sata init; fatload sata 0:${fdt_partition}
...
#define MACRO_ENV_RAMFS_SRC_USDHCI     \
	fatload mmc ${ramfs_device_id}:${ramfs_partition}  ${ramfs_loadaddr} ${ramfs_file}

#define MACRO_ENV_RAMFS_SRC_USB     \
	usb start; fatload usb ${ramfs_device_id}:${ramfs_partition} ${ramfs_loadaddr} ${ramfs_file}

#define MACRO_ENV_RAMFS_SRC_SATA    \
	sata init; fatload sata 0:${ramfs_partition} ${ramfs_loadaddr} ${ramfs_file}
