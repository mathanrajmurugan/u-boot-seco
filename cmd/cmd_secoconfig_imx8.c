...
/*
 * |__________________________ CONFIG_TARGET_SECO_IMX8QM_C43_______________________|
 */
#if defined(CONFIG_TARGET_SECO_IMX8QM_C43)
static data_boot_dev_t kern_dev_list [] = {
        { DEV_EMMC,     "eMMC onboard",   ENV_KERNEL_SRC_MMC,    BOOT_DEV_ID_EMMC,    LOAD_ADDR_KERNEL_LOCAL_DEV,   "Image" },
...
static data_boot_dev_t hdprx_dev_list [] = {
...
static data_boot_dev_t hdptx_dev_list [] = {
...
#endif   /*  defined(CONFIG_TARGET_SECO_IMX8QM_C43)  */
/*  __________________________________________________________________________
 * |__________________________________________________________________________|
 */
...
#if defined CONFIG_TARGET_SECO_IMX8QM_C43
static overlay_struct_mode_t overlay_video_mode_list [] = {
        { "HDMI FULLHD", "seco-imx8qm-c43-hdmi.dtbo"},
        { "HDMI 4k", "seco-imx8qm-c43-hdmi.dtbo"},
        { "LVDS1 1920x1080", "seco-imx8qm-c43-lvds1.dtbo"},
        { "LVDS2 1920x1080", "seco-imx8qm-c43-lvds2.dtbo"},
        { "DP 1920x1080", "seco-imx8qm-c43-dp.dtbo"},
        { "EDP SN65DSI86-1920x1080", "seco-imx8qm-c43-sn65dsi86.dtbo"},
};
...
#endif
#if defined CONFIG_TARGET_SECO_IMX8MQ_C25 || defined CONFIG_TARGET_SECO_IMX8MQ_C20 || defined CONFIG_TARGET_SECO_IMX8QM_C26  || defined CONFIG_TARGET_SECO_IMX8QM_C43 || defined CONFIG_TARGET_SECO_IMX8MM_C61 || defined CONFIG_TARGET_SECO_IMX8QXP_C57
		ch = *GET_OVERLAY_USE;
		if ( strcmp(&ch,"0") == 0 )
		        strcpy (&ch, "0");
		else
...
int selection_video_overlay_files (overlay_struct_mode_t overlay_video_mode_list[], int num_element) {
	...
	if(selection & (1<<HDMI)) { /* HDMI FULLHD selection */
		env_set("hdptx_file","hdmitxfw.bin\0");
                env_set("options","drm_kms_helper.edid_firmware=edid/1920x1080.bin\0");
		selection = 1;
	} else if(selection & (1<<HDMI_4K)) { /* HDMI 4K selection */
		env_set("hdptx_file","hdmitxfw.bin\0");
                env_set("options","drm_kms_helper.edid_firmware=edid/3840x2160.bin\0");
                selection = 1;
...
//		size = PHYS_SDRAM_SIZE;
#endif
#if defined CONFIG_TARGET_SECO_IMX8QM_C26 || defined CONFIG_TARGET_SECO_IMX8QM_C43 || defined CONFIG_TARGET_SECO_IMX8MM_C61
                size = PHYS_DRAM_IS_2GB;
#endif
#if defined CONFIG_TARGET_SECO_IMX8MM_C72
		if(C72_IS_1GB)
