...
#define MODEM_RESET                            IMX_GPIO_NR(3, 11)
#define MODEM_EMERG                            IMX_GPIO_NR(3, 10)
#define MODEM_PWRKEY                           IMX_GPIO_NR(3, 15)
#define MODEM_3V8                              IMX_GPIO_NR(4, 11)
...
{
    SETUP_IOMUX_PADS(modem_pads);
    gpio_request(MODEM_RESET, "modem reset");
    gpio_direction_output(MODEM_RESET, 1); // EN_RESET_N
    gpio_request(MODEM_EMERG, "modem EMERG");
    gpio_direction_output(MODEM_EMERG, 1); // EN_EMERG
    gpio_request(MODEM_PWRKEY, "modem power key");
    gpio_direction_output(MODEM_PWRKEY, 1); // EN_PWRKEY
    gpio_request(MODEM_3V8, "modem power voltage");
    gpio_direction_output(MODEM_3V8, 1); // EN_3v8
}
