...
#define SECO_CODE_0	IMX_GPIO_NR(0,0)
#define SECO_CODE_1     IMX_GPIO_NR(0,2)	

iomux_cfg_t const board_conf_pads[] = {

        /* RAM CONFIG */
	SC_P_SIM0_CLK | MUX_MODE_ALT(3) | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* SECO_CODE_0 */
	SC_P_SIM0_IO  | MUX_MODE_ALT(3) | MUX_PAD_CTRL(GPIO_PAD_CTRL), /* SECO_CODE_1 */
