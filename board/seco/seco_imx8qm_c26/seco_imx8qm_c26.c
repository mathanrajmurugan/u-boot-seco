...
#ifdef CONFIG_CMD_SECO_UART
	/* Init additional uart */

        /* Power up additional UART */
        ...
        /* Enable additional UART clock root */
...
static iomux_cfg_t pad_enet0[] = {
	...
	SC_P_ENET1_REFCLK_125M_25M_LSIO_GPIO4_IO16 | MUX_PAD_CTRL(ENET_NORMAL_PAD_CTRL),
};

#define FEC_RST_PAD IMX_GPIO_NR(4,16)
