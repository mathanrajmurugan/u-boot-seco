...
/* Video Mode List */
/* Aligne this list with the file include/seco/seco_imx8qm_c26_setup.h */
overlay_struct_mode_t overlay_video_mode_list [] = {
        { "HDMI FULLHD", "seco-imx8qm-c26-hdmi.dtbo"},
        { "HDMI 4k", "seco-imx8qm-c26-hdmi.dtbo"},
        { "LVDS 800x480", "seco-imx8qm-c26-lvds-single.dtbo"},
        { "LVDS 1920x1080", "seco-imx8qm-c26-lvds-dual.dtbo"},
        { "DP 1920x1080", "seco-imx8qm-c26-dp.dtbo"},
        { "LVDS 1920x1080 + HDMI", "seco-imx8qm-c26-hdmi-lvds.dtbo"},
        { "LVDS 1920x1080 + DP", "seco-imx8qm-c26-dp-lvds.dtbo"},
};
...
overlay_struct_mode_t overlay_addons_list [] = {
        { "No addons", "" },
        { "OV5640 CSI0", "seco-imx8qm-c26-ov5640-csi0.dtbo"},
        { "OV5640 CSI1", "seco-imx8qm-c26-ov5640-csi1.dtbo"},
};
